...
export default function RulesProdutosImportados({
  deliveryRule,
  jurisdiction,
  onChangeDelivery,
  ...
  return (
    <>
      ...
      {deliveryRule === 'antecipar' && (
        <strong style={{ color: 'green' }}>Data de vencimento será dia 02</strong>
      )}
      {deliveryRule === 'prorrogar' && (
        <strong style={{ color: 'blue' }}>Data de vencimento será dia 04</strong>
      )}
